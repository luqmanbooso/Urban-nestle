...
#submitButton:disabled {
    ...
    ?>
    <header>
        <h1>Apartment Sale Loan Application</h1>
    </header>
    <main>
        <section class="form-container">
            <h2>Loan Application Form</h2>
            <form action="insertloan.php?id=<?php  echo $row["aid"] ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea name="apartment_address" id="apartment_address" required></textarea>
                </div>
                <div class="form-group">
                    <label for="purchase_price">Apartment Purchase Price (LKR): <?php echo $row["price"]; ?></label></div>
                <div class="form-group">
                    <label for="employment_status">Employment Status:</label>
                    <select name="employment_status" id="employment_status" required>
                        <option value="">Select</option>
                        <option value="employed" id="employed">Employed</option>
                        <option value="self-employed" id="self-employed">Self-Employed</option>
                    </select>
                </div>
                <div class="form-group">
                <div class="form-group">
    <label for="annual_income">Annual Income (LKR):</label>
    <input type="number" name="annual_income" id="annual_income" min="0" required>
</div>
<div class="form-group">
...
document.getElementById('annual_income').addEventListener('input', function() {
    document.getElementById('submitButton').disabled = this.value > 5000000;
});
</script>
